...
<div class="flex w-72 flex-col">
	...
	<input
		class="Agdasima h-12 rounded-xl text-center text-xl shadow-[inset_2px_-2px_2px_0_rgba(33,33,33,0.5),inset_-2px_2px_2px_0_rgba(33,33,33,0.5)] outline-none placeholder:text-[#212121] placeholder:opacity-20"
		{name}
		{type}
		id={label}
		oninput={async (e) => {
